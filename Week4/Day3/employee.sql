...
-- (
--    DEPTCODE INTEGER NOT NULL DEFAULT nextval('department_seq') PRIMARY KEY,
--    DeptName CHAR(30),
...
-- INNER JOIN DEPARTMENT
-- ON department_code = DEPTCODE
-- ORDER BY LOCATION ASC, EmpFName ASC

-- Display EMPFNAME and "TOTAL SALARY" for each employee (commission and salary)
SELECT EmpFName, EmpLName, Salary+Commission as Total_sum
FROM EMPLOYEE
